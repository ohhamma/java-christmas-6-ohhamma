...
class BadgeTest {
    ...
    @ParameterizedTest
    void benefitAmountUnder5000(int benefitAmount) {
        // given, when
    ...
    @ParameterizedTest
    void benefitAmountBetween5000And10000(int benefitAmount) {
        // given, when
        Badge badge = Badge.from(benefitAmount);
    ...
    @ParameterizedTest
    void benefitAmountBetween10000And20000(int benefitAmount) {
        // given, when
        Badge badge = Badge.from(benefitAmount);
    ...
    @ParameterizedTest
    void benefitAmountOver20000(int benefitAmount) {
        // given, when
        Badge badge = Badge.from(benefitAmount);
